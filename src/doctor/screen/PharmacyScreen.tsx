...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, marginLeft: 10, fontWeight: '600', fontSize: 14, color: COLORS.primary, fontFamily: FONT_SERIF },
  ...
  cardBrand: { fontSize: 9, fontWeight: '900', color: COLORS.secondary, letterSpacing: 1, fontFamily: FONT_SERIF },
  ...
  ratingText: { marginLeft: 5, fontSize: 12, fontWeight: '800', color: COLORS.primary, fontFamily: FONT_SERIF },
  stockBox: { flexDirection: 'row', alignItems: 'center' },
  stockDot: { width: 8, height: 8, borderRadius: 4, marginRight: 6 },
  stockText: { fontSize: 11, fontWeight: '700', color: COLORS.secondary, fontFamily: FONT_SERIF },
  ...
  addBtnText: { color: 'white', fontSize: 12, fontWeight: '900', marginLeft: 10, letterSpacing: 1, fontFamily: FONT_SERIF },
