...
const MarketplaceScreen = () => {
  ...
  const ProductCard = ({ title, brand, price, info, image, type, verified, commission }: any) => (
...
const styles = StyleSheet.create({
  ...
  infoText: { fontSize: 13, color: COLORS.secondary, marginTop: 4 },
