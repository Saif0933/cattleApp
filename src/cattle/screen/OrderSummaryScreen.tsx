...
const styles = StyleSheet.create({
  ...
  productBrand: { fontSize: 10, fontWeight: '900', color: COLORS.secondary, letterSpacing: 1 },
  productTitle: { fontSize: 16, fontWeight: '900', color: COLORS.primary, marginTop: 4, fontFamily: FONT_SERIF },
  productWeight: { fontSize: 12, color: COLORS.secondary, marginTop: 2 },
  productPrice: { fontSize: 18, fontWeight: '900', color: COLORS.emerald, marginTop: 6 },
  ...
  addressName: { fontSize: 14, fontWeight: '900', color: COLORS.primary },
  addressText: { fontSize: 12, color: COLORS.secondary, marginTop: 2, lineHeight: 18 },
  addressPhone: { fontSize: 12, fontWeight: '700', color: COLORS.primary, marginTop: 4 },
  editText: { fontSize: 13, fontWeight: '800', color: COLORS.sky },
  ...
  paymentText: { fontSize: 14, fontWeight: '800', color: COLORS.primary },

  breakdownCard: { backgroundColor: 'white', borderRadius: 25, padding: 20, elevation: 3 },
  detailRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12 },
  detailLabel: { fontSize: 14, color: COLORS.secondary, fontWeight: '600' },
  detailValue: { fontSize: 14, color: COLORS.primary, fontWeight: '800' },
  divider: { height: 1, backgroundColor: COLORS.background, marginVertical: 10 },
  totalRow: { marginTop: 5 },
  totalText: { fontSize: 16, fontWeight: '900', color: COLORS.primary },
  totalValue: { fontSize: 20, fontWeight: '900', color: COLORS.emerald },
  ...
  footerTotalLabel: { fontSize: 10, fontWeight: '900', color: COLORS.secondary, letterSpacing: 1 },
  footerTotalValue: { fontSize: 24, fontWeight: '900', color: COLORS.primary },
  placeOrderBtn: { 
